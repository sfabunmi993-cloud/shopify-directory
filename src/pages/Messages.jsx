              ...
              filteredConvs.map(conv => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3.5 flex items-center gap-3 hover:bg-muted/30 transition-colors border-b border-border/40 last:border-0 ${isActive ? 'bg-primary/5' : ''}`}
                  >
