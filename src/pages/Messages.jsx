    ...
    <div className="flex flex-col" style={{ height: 'calc(100vh - 64px)' }}>
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className={`w-full md:w-80 lg:w-96 border-r border-border flex flex-col bg-white shrink-0 ${mobileView === 'chat' ? 'hidden md:flex' : 'flex'}`}>
          {/* Sidebar header */}
          <div className="<!DOCTYPE html> <html lang=\"en\"> <head> <meta charset=\"utf-8\"/> <link href=\"https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/69a906e18aa1b957017d7903/d29531789_ChatGPTImageMar5202612_15_08PM.png\" rel=\"icon\" type=\"image/svg+xml\"/> content=\"width=device-width, initial-scale=1.0\" name=\"viewport\"/> href=\"/manifest.json\" rel=\"manifest\"/> <title> Chat | ChatFlow \\ </title> <script crossorigin=\"\" src=\"/assets/index-CnaSRGwu.js\" type=\"module\"> </script> href=\"/assets/index-C7BjBkuN.css\" rel=\"stylesheet\"/> if (window.self === window.top) { let lastPath = \"\"; function getPageNameFromPath(path) const segments path.split(\"/\").filter(Boolean); return segments[0] || null; } trackPageView() path window.location.pathname; (path === lastPath) return; path; pageName \"home\"; appId \"69a906e18aa1b957017d7903\"; (!appId) fetch(`/api/app-logs/${appId}/log-user-in-app/${pageName}`, {\n      method: \"POST\",\n    }).catch(() => {}); originalPushState history.pushState.bind(history); history.pushState (...args) originalPushState(...args); trackPageView(); }; originalReplaceState history.replaceState.bind(history); history.replaceState originalReplaceState(...args); window.addEventListener(\"popstate\", trackPageView); content=\"A secure, real-time messaging platform designed for seamless team communication and private conversations, featuring instant delivery rich media support. \" name=\"description\"/> content=\"Chat \\\" property=\"og:title\"/> property=\"og:description\"/> content=\"https://fervent-chat-flow-sync.base44.app/Chat\" property=\"og:url\"/> content=\"website\" property=\"og:type\"/> content=\"ChatFlow property=\"og:site_name\"/> name=\"twitter:title\"/> name=\"twitter:description\"/> content=\"summary_large_image\" name=\"twitter:card\"/> name=\"twitter:url\"/> content=\"https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/render/image/public/base44-prod/public/69a906e18aa1b957017d7903/d29531789_ChatGPTImageMar5202612_15_08PM.png?width=1200&amp;height=630&amp;resize=contain\" property=\"og:image\"/> name=\"twitter:image\"/> content=\"yes\" name=\"mobile-web-app-capable\"/> content=\"black\" name=\"apple-mobile-web-app-status-bar-style\"/> name=\"apple-mobile-web-app-title\"/> content=\"noindex, nofollow\" name=\"robots\"/> async=\"true\" data-app-id=\"69a906e18aa1b957017d7903\" data-platform-url=\"https://app.base44.com\" src=\"/static/js/badge.js\"> </head> <body> <div id=\"root\"> </div> </body> </html>">
