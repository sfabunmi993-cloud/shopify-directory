              ...
              return (
                ...
                className={`w-full text-left px-3 sm:px-4 py-2.5 sm:py-3.5 flex items-center gap-2.5 sm:gap-3 hover:bg-muted/30 transition-colors border-b border-border/40 last:border-0 ${isActive ? 'bg-primary/5' : ''}`}>
                  ...
                  <div className="relative shrink-0">
                    {isPartnerSide ?
                  <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center text-xs sm:text-sm font-bold text-primary border border-border/50">
                ...
                return (
                  <React.Fragment key={msg.id}>
                    ...
                    <div className="flex justify-start mb-2 sm:mb-3">
                          <div className="max-w-[90%] sm:max-w-[70%] bg-white border-2 border-primary/20 rounded-xl sm:rounded-2xl p-2.5 sm:p-4 shadow-sm">
                            <div className="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="text-xs sm:text-sm font-bold text-primary mb-1">Hire Request</p>
                                {msg.subject && <p className="text-xs text-muted-foreground mb-2">{msg.subject}</p>}
                                <div className="bg-muted/50 rounded-lg p-2 sm:p-3 mb-2 sm:mb-3">
                                  <p className="text-xs font-semibold mb-1">Project Details</p>
                                  <p className="text-xs whitespace-pre-line line-clamp-4 sm:line-clamp-none">{msg.hire_details}</p>
                                </div>
                                ...
                                disabled={sending}
                                className="flex-1 bg-green-600 hover:bg-green-700 text-white rounded-full h-8 text-xs">
                                
                                    <ThumbsUp className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1" />
                                    {sending ? '...' : 'Accept'}
                                  </Button>
                                  <Button
                                size="sm"
                                ...
                                disabled={sending}
                                variant="outline"
                                className="flex-1 rounded-full border-red-200 text-red-600 hover:bg-red-50 h-8 text-xs">
                                
                                    <ThumbsDown className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1" />
                                    {sending ? '...' : 'Decline'}
                                  </Button>
                                </div>
                              </div>
                    ...
                    isHireRequest ?
                    <div className="flex justify-start mb-2 sm:mb-3">
                          <div className={`max-w-[90%] sm:max-w-[70%] rounded-xl sm:rounded-2xl p-2.5 sm:p-4 border-2 shadow-sm ${
                    ...
                    <div className={`flex ${isMe ? 'justify-end' : 'justify-start'} ${isLastInGroup ? 'mb-2' : 'mb-0.5'}`}>
                          {!isMe &&
                      <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-primary/10 flex items-center justify-center text-[10px] sm:text-[11px] font-bold text-primary shrink-0 mr-1.5 self-end ${isLastInGroup ? 'opacity-100' : 'opacity-0'}`}>
