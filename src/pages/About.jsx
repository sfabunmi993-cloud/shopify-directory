    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 py-14 space-y-12">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed text-base">nShopify Partners Directory is built and maintained by Fabunmi Samuel And Omoniyi Enitan Johnsona dedicated team passionate about the Shopify ecosystem. We are a group of e-commerce enthusiasts, developers, and community builders who believe that finding the right expert should be simple, transparent, and accessible to everyone. Our team continuously improves the platform based on feedback from both partners and merchants to ensure the best possible experience on all sides.
